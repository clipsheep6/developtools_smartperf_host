...
import {
    ...
    fillCacheData,
    findRange,
    FilterConfig, dataFilterHandler, drawFlagLineSegment, drawSelectionRange, drawLinkLines
    // @ts-ignore
...
describe('ProcedureWorkerCommon Test', () => {
    ...
    it('ProcedureWorkerCommon34', function () {
        ...
        expect(drawFlagLineSegment(ctx, hoverFlag, selectFlag, {y: 5, height: 30, x: 1, width: 3})).toBeUndefined();
    });
