...
import {
  ...
  filterDataByLayer
} from '../../../../src/trace/database/data-trafic/DataFilter';
...
describe('DataFilter Test', () => {
  ...
  it('DataFilterTest0304', () => {
    ...
    expect(result).toEqual([
      {startKey: 0, durKey: 100, startNS: 0, endNS: 1000, px: 100, durTmp: undefined, layerKey: 1,},
      {startKey: 100, durKey: 200, startNS: 1001, endNS: 2000, px: 205, durTmp: undefined, layerKey: 2,},
    ]);
  });
});