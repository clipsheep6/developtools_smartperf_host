...
import { cpuStateSender } from '../../../../src/trace/database/data-trafic/CpuStateSender';
import { TraceRow } from '../../../../src/trace/component/trace/base/TraceRow';
import { CpuStateStruct } from '../../../../src/trace/database/ui-worker/ProcedureWorkerCpuState';
...
describe('CpuStateSender Test', () => {
  ...
  it('CpuStateSenderTest01 ', function () {
    threadPool.submitProto = jest.fn((query: number, params: any, callback: Function) => {
      callback(cpuStateData, cpuStateData.length, true);
    });
    let filterId = 1;
