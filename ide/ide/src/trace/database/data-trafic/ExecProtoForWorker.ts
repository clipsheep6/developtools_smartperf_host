...
import { cpuFreqDataReceiver } from './CpuFreqDataReceiver';
import { processDataReceiver } from './ProcessDataReceiver';
import { threadDataReceiver } from './ThreadDataReceiver';
import { funcDataReceiver } from './FuncDataReceiver';
import { hiperfCpuDataReceiver } from './HiperfCpuDataReceiver';
import { hiperfProcessDataReceiver } from './HiperfProcessDataReceiver';
import { hiperfThreadDataReceiver } from './HiperfThreadDataReceiver';
import { cpuStateReceiver } from './CpuStateReceiver';
import { cpuFreqLimitReceiver } from './CpuFreqLimitDataReceiver';
import { clockDataReceiver } from './ClockDataReceiver';
import { irqDataReceiver } from './IrqDataReceiver';
import { processExpectedDataReceiver } from './ProcessExpectedDataReceiver';
import { processActualDataReceiver } from './ProcessActualDataReceiver';
import { hiPerfCallChartDataHandler, hiPerfCallStackCacheHandler } from './HiperfCallChartReceiver';
import { virtualMemoryDataReceiver } from './VirtualMemoryDataReceiver';
import { processMemDataReceiver } from './ProcessMemDataReceiver';
import { processStartupDataReceiver } from './ProcessStartupDataReceiver';
import { processSoInitDataReceiver } from './ProcessSoInitDataReceiver';
import {
  dmaDataReceiver,
  gpuDataReceiver,
...
import { processDeliverInputEventDataReceiver } from './ProcessDeliverInputEventDataReceiver';
