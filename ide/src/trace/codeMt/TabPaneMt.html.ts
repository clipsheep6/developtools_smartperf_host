...
export const MtSettingHtml = `
    ...
    <lit-table id="tb-parallel" style="height: auto" tree>
        <lit-table-column class="freq-sample-column" width="1fr" title="Process/Core" data-index="title" key="title" align="flex-start" retract>
        </lit-table-column>
        <lit-table-column class="freq-sample-column" width="1fr" title="Thread count" data-index="tCount" key="tCount" align="flex-start">
        </lit-table-column>
        <lit-table-column class="freq-sample-column" width="1fr" title="Same physics core" data-index="group" key="group" align="flex-start" >
        </lit-table-column>
        <lit-table-column class="freq-sample-column" width="1fr" title="Running duration(ms)" data-index="dur" key="dur" align="flex-start" >
        </lit-table-column>
        <lit-table-column class="freq-sample-column" width="1fr" title="Parallel duration(ms)" data-index="pDuration" key="pDuration" align="flex-start" >
        </lit-table-column>
    ...
    <lit-popover placement="topLeft" class="popover" haveRadio="true" trigger="click" id="data-mining-popover">
        ...
        <span class="describe tree max-spacing" id="core-mining">Logical Kernel Pairing</span>
    </lit-popover>
</div>
`;