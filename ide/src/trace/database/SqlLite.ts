...
import { type LtpoStruct } from './ui-worker/ProcedureWorkerLTPO';
...
import { StartUpStrut } from './ui-worker/ProcedureWorker';
...
export const queryProcessStartup = (pid: number): Promise<Array<StartUpStrut>> =>
  query(
    'queryProcessStartup',
    `
    select
