...
export class SpKeyboard extends BaseElement{
    ...
    initElements(): void {
        ...
        let keyboard_div = document.querySelector('body > sp-application')!.shadowRoot!.querySelector<SpKeyboard>('#sp-keyboard')!;
        let welcon_div = document.querySelector('body > sp-application')!.shadowRoot!.querySelector<SpKeyboard>('#sp-welcome')!;
        let shadow_box = this.shadowRoot?.querySelector('.shadow-box')!;
        closeWindow!.addEventListener('click',()=>{
          keyboard_div.style.visibility = 'hidden';
          welcon_div.style.visibility = 'visible';
        })
