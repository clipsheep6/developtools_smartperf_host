...
export class TraceSheet extends BaseElement {
  ...
  displayFuncData = (names: string[], data: FuncStruct, scrollCallback: Function,callback?: ((data: Array<any>, str:string) => void)): Promise<void> =>
  ...
  ): Promise<void> => this.displayTab<TabPaneCurrentSelection>('current-selection').setCpuData(data, callback, scrollCallback);
  displayJankData = (
    data: JankStruct,
