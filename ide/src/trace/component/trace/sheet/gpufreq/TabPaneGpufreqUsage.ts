  ...
  set data(clockCounterValue: SelectionParam) {
    ...
    getGpufreqData(clockCounterValue.leftNs, clockCounterValue.rightNs, false).then((result: Array<GpuCountBean>): void => {
      if (result !== null && result.length > 0) {
        ...
        resultList[0].dur = resultList[1] ? resultList[1].startNS - clockCounterValue.leftNs : clockCounterValue.rightNs - clockCounterValue.leftNs;
        resultList[0].value = resultList[0].dur * resultList[0].val;
        resultList[resultList.length - 1].dur = resultList.length - 1 !== 0 ? clockCounterValue.rightNs - resultList[resultList.length - 1].startNS : resultList[0].dur;
