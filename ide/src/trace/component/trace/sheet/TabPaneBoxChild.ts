...
<lit-table id="tb-cpu-thread" style="height: auto">
    <lit-table-column order width="20%" title="Start Time" data-index="startTime" key="startTime" align="flex-start" order ></lit-table-column>
    <lit-table-column order width="20%" title="Process" data-index="processName" key="processName" align="flex-start" order ></lit-table-column>
    <lit-table-column order width="20%" title="Thread" data-index="threadName" key="threadName" align="flex-start" order ></lit-table-column>
