...
| @(mali.so _,libGLES_mali.so _)                | 只显示Responsible Library包含mali.so或者libGLES_mali.so的数据                                                                                         |
...
|                                               |                                                                                                                                                       |
| @(_ table) - (libark _)                       | 只显示Responsible Caller包含table且Responsible Library不为libark的数据                                                                                |
